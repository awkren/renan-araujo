  ...
  return (
    <div id='content-two' className='flex flex-row mt-[1rem]'>
      <div className='text-center w-[40%]'>
        ...
        <p className='text-left'>We recently interviewed a person very close to him, and this person said to us that he loves learning new technologies and skills. Everything he knows now, he learned by himself, and about programming couldn't be different, he is putting a lot of effort to reach his goals, said a misterious person.</p>
      </div>
      ...
      <div className='ml-[.4rem] w-[100%]'>
        ...
        <div className='projects'>
          <div className='mt-[1rem]'>
            ...
            <img className='w-[400px] border-[1px] border-black' src={cryptoView} alt='/'/>
            <div className='flex flex-row justify-evenly mt-[1rem] mb-[1rem]'>
              <p title='See website on the internet'><FaGlobe/></p>
              <p title='Website code on GitHub'><FaGithub/></p>
            </div>
          ...
          <div className='mt-[1rem]'>
            ...
            <img className='w-[400px] border-[1px] border-black' src={fakePage} alt='/'/>
            <div className='flex flex-row justify-evenly mt-[1rem] mb-[1rem]'>
              <p title='See website on the internet'><FaGlobe/></p>
              <p title='Website code on GitHub'><FaGithub/></p>
            </div>
          ...
          <div className='mt-[1rem]'>
            ...
            <img className='w-[400px] border-[1px] border-black' src={cryptoViewServer} alt='/'/>
            <div className='flex flex-row justify-evenly mt-[1rem] mb-[1rem]'>
              <p title='See website on the internet'><FaGlobe/></p>
              <p title='Website code on GitHub'><FaGithub/></p>
            </div>
          ...
          <div className='mt-[1rem]'>
            ...
            <img className='w-[400px] border-[1px] border-black' src={renanAraujo} alt='/'/>
            <div className='flex flex-row justify-evenly mt-[1rem] mb-[1rem]'>
              <p title='See website on the internet'><FaGlobe/></p>
              <p title='Website code on GitHub'><FaGithub/></p>
            </div>
