...
const Name = () => {
  return (
    <div className='mt-[-1.5rem]'>
      ...
      <div className='mt-[-1.5rem]'>
        <p className='italic text-[1.8rem] text-center font-[OldNewspaper]'>A front-end developer with a very strong analytical background, who loves to build things!</p>
      </div>
    </div>
  )
}
